...
import coin from "./gifs/coin.gif";
import snakes from "./gifs/snakes.gif";
const Game = () => {
  ...
  return (
    <div role="button" tabIndex="0" onKeyDown={(e) => moveSnake(e)}>
      ...
      <div className="containersnake">
        ...
        ></img>
        <img
          style={{ width: "150px", height: "70px", float: "right" }}
          src={snakes}
          alt="snake"
        ></img>
      </div>
